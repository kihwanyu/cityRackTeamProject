...
<body>
	...
	<form id="idForm" action="<%=request.getContextPath()%>/searchId.em"
		method="post">
		<div class=container>
			<div class=row>
				<!-- 아이디 찾기 -->
				<div class="col-md-6">
					...
					<input class="input" type="text" name="nameId" id="nameId"
						placeholder="이름을 입력해주세요."> <input class="input" type="tel"
						name="phoneId" id="phoneId"
						placeholder="가입하신 휴대전화 번호를 입력해주세요(-제외)">
	...
	<form id="pwdForm" action="<%=request.getContextPath()%>/searchPwd.do"
		...
		<div class="col-md-6">
			...
			<input class="input" type="text" name="namePwd" id="namePwd"
				placeholder="이름을 입력해주세요."> <input class="input" type="text"
				name="emailPwd" id="emailPwd" placeholder="가입하신 이메일을 입력해주세요.">

			<button type="submit" align="center" class="submitBtn">임시
				비밀번호 발급</button>
