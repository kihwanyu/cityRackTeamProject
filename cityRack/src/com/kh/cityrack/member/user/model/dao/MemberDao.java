	...
	public Member loginCheck(Connection con, String m_mail, String m_password) {
		...
		try {
			...
			if(rset.next()) {
				...
				loginUser.setM_no(rset.getInt("mNo"));
				loginUser.setM_mail(rset.getString("mMail"));
				loginUser.setC_code(rset.getString("cCode"));
				loginUser.setM_password(rset.getString("mPassword"));
				loginUser.setM_name(rset.getString("mName"));
				loginUser.setM_gender(rset.getString("mGender"));
				loginUser.setM_birthDay(rset.getDate("mBirthDay"));
				loginUser.setM_address(rset.getString("mAddress"));
				loginUser.setM_tel(rset.getString("mTel"));
				loginUser.setM_phone(rset.getString("mPhone"));
				loginUser.setM_enorll_date(rset.getDate("mEnrollDate"));
				loginUser.setM_leave_yn(rset.getString("mLeaveYn"));
