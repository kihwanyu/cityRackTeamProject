				...
				<form id="survey_easy-form" class="clearfix">
					...
					<div class="col-survey">
						...
						<div class="survey_radio">
							<input type="radio" name="q1" id="q1_yes" value="y" checked> 
						...
						<div class="survey_radio">
							<input type="radio" name="q2" id="q2_yes" value="y" checked> 
							<label for="q2_yes">Yes</label> &nbsp; 
							<input type="radio" name="q2" id="q2_no" value="n"> 
							<label for="q2_no">No</label> &nbsp;&nbsp; 
							<strong>해산물을 먹으면 좋지 않다.</strong>
						</div>
						<div class="survey_radio">
							<input type="radio" name="q3" id="q3_yes" value="y" checked> 
							<label for="q3_yes">Yes</label> &nbsp; 
							<input type="radio" name="q3" id="q3_no" value="n"> 
							<label for="q3_no">No</label> &nbsp;&nbsp; 
							<strong>인삼을 먹고 불편한 경험이 있다 (두통, 답답함, 열감, 가슴 뜀 등).</strong>
						</div>
						<div class="survey_radio">
							<input type="radio" name="q4" id="q4_yes" value="y" checked> 
							<label for="q4_yes">Yes</label> &nbsp; 
							<input type="radio" name="q4" id="q4_no" value="n"> 
							<label for="q4_no">No</label> &nbsp;&nbsp; 
							<strong>대변을 자주 본다.</strong>
						</div>
						<div class="survey_radio">
							<input type="radio" name="q5" id="q5_yes" value="y" checked> 
							<label for="q5_yes">Yes</label> &nbsp; 
							<input type="radio" name="q5" id="q5_no" value="n"> 
							<label for="q5_no">No</label> &nbsp;&nbsp; 
							<strong>매운 음식을 먹으면 좋지 않다.</strong>
						</div>
						<div class="survey_radio">
							<input type="radio" name="q6" id="q6_yes" value="y" checked> 
							<label for="q6_yes">Yes</label> &nbsp; 
							<input type="radio" name="q6" id="q6_no" value="n"> 
							<label for="q6_no">No</label> &nbsp;&nbsp; 
							<strong>닭고기를 먹고 불편한 적이 있다.</strong>
						</div>
						<div class="survey_radio">
							<input type="radio" name="q7" id="q7_yes" value="y" checked> 
							<label for="q7_yes">Yes</label> &nbsp; 
							<input type="radio" name="q7" id="q7_no" value="n"> 
							<label for="q7_no">No</label> &nbsp;&nbsp; 
							<strong>성격이 급해 용두사미가 되기 쉽다.</strong>
						</div>
						<div class="survey_radio">
							<input type="radio" name="q8" id="q8_yes" value="y" checked> 
							<label for="q8_yes">Yes</label> &nbsp; 
							<input type="radio" name="q8" id="q8_no" value="n"> 
							<label for="q8_no">No</label> &nbsp;&nbsp; 
							<strong>마음이 항상 바쁘다.</strong>
						</div>
						<div class="survey_radio">
							<input type="radio" name="q9" id="q9_yes" value="y" checked> 
							<label for="q9_yes">Yes</label> &nbsp; 
							<input type="radio" name="q9" id="q9_no" value="n"> 
							<label for="q9_no">No</label> &nbsp;&nbsp; 
							<strong>땀을 흘리고 나면 피곤하거나 지치는 것 같다.</strong>
						</div>
						<div class="survey_radio">
							<input type="radio" name="q10" id="q10_yes" value="y" checked> 
							<label for="q10_yes">Yes</label> &nbsp; 
							<input type="radio" name="q10" id="q10_no" value="n"> 
							<label for="q10_no">No</label> &nbsp;&nbsp; 
							<strong>육식을 먹으면 좋지 않다.</strong>
						</div>
						<div class="survey_radio">
							<input type="radio" name="q11" id="q11_yes" value="y" checked> 
							<label for="q11_yes">Yes</label> &nbsp; 
							<input type="radio" name="q11" id="q11_no" value="n"> 
							<label for="q11_no">No</label> &nbsp;&nbsp; 
							<strong>의욕이 지나치면 꼼꼼하고 까다로워진다.</strong>
						</div>
						<div class="survey_radio">
							<input type="radio" name="q12" id="q12_yes" value="y" checked> 
							<label for="q12_yes">Yes</label> &nbsp; 
							<input type="radio" name="q12" id="q12_no" value="n"> 
							<label for="q12_no">No</label> &nbsp;&nbsp; 
							<strong>뒷머리 아랫부분이 윗부분보다 나왔다.</strong>
						</div>
						<div class="survey_radio">
							<input type="radio" name="q13" id="q13_yes" value="y" checked> 
							<label for="q13_yes">Yes</label> &nbsp; 
							<input type="radio" name="q13" id="q13_no" value="n"> 
							<label for="q13_no">No</label> &nbsp;&nbsp; 
							<strong>광대뼈가 튀어나왔다.</strong>
						</div>
						<div class="survey_radio">
							<input type="radio" name="q14" id="q14_yes" value="y" checked> 
							<label for="q14_yes">Yes</label> &nbsp; 
							<input type="radio" name="q14" id="q14_no" value="n"> 
							<label for="q14_no">No</label> &nbsp;&nbsp; 
							<strong>자존심이 강해 맘대로 성취를 못하면 쉽게 흥분하고 분노를 한다.</strong>
						</div>
						<div class="survey_radio">
							<input type="radio" name="q15" id="q15_yes" value="y" checked> 
							<label for="q15_yes">Yes</label> &nbsp; 
							<input type="radio" name="q15" id="q15_no" value="n"> 
							<label for="q15_no">No</label> &nbsp;&nbsp; 
							<strong>어깨가 넓고 허리가 가늘며 엉덩이가 나와 몸매가 곱다.</strong>
						</div>
						<div class="survey_radio">
							<input type="radio" name="q16" id="q16_yes" value="y" checked> 
							<label for="q16_yes">Yes</label> &nbsp; 
							<input type="radio" name="q16" id="q16_no" value="n"> 
							<label for="q16_no">No</label> &nbsp;&nbsp; 
							<strong>남에게 인색한 편이다.</strong>
						</div>
						<div class="survey_radio">
							<input type="radio" name="q17" id="q17_yes" value="y" checked> 
							<label for="q17_yes">Yes</label> &nbsp; 
							<input type="radio" name="q17" id="q17_no" value="n"> 
							<label for="q17_no">No</label> &nbsp;&nbsp; 
							<strong>인삼을 먹고 효과를 보았다.</strong>
						</div>
						<div class="survey_radio">
							<input type="radio" name="q18" id="q18_yes" value="y" checked> 
							<label for="q18_yes">Yes</label> &nbsp; 
							<input type="radio" name="q18" id="q18_no" value="n"> 
							<label for="q18_no">No</label> &nbsp;&nbsp; 
							<strong>1주일에 2~3번 변을 봐도 불편하지 않다.</strong>
						</div>
						<div class="survey_radio">
							<input type="radio" name="q19" id="q19_yes" value="y" checked> 
							<label for="q19_yes">Yes</label> &nbsp; 
							<input type="radio" name="q19" id="q19_no" value="n"> 
							<label for="q19_no">No</label> &nbsp;&nbsp; 
							<strong>마르고 여윈 모습으로 빼빼하고 가늘다.</strong>
						</div>
						<div class="survey_radio">
							<input type="radio" name="q20" id="q20_yes" value="y" checked> 
							<label for="q20_yes">Yes</label> &nbsp; 
							<input type="radio" name="q20" id="q20_no" value="n"> 
