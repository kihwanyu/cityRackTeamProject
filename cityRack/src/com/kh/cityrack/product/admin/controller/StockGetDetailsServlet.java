...
public class StockGetDetailsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//전체 목록 갯수를 리턴 받음
		int listCount = new StockService().getDetailListCount(pcode);
		...
		sList = new StockService().stockDetailListGetAll(currentPage, limit, pcode);
		//
		String page = "";
		
		if(sList != null){
			int sAmount = new StockService().stockGetAmountSum(pcode, "입고");
			int rAmount = new StockService().stockGetAmountSum(pcode, "출고");
