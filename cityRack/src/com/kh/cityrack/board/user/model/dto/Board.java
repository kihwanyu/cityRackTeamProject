...
public class Board implements Serializable {
	...
	public Board(int bo_no, String bo_category, String bo_division, int bo_pno, Date bo_date, int m_no, String bo_title,
			String bo_content, int bo_hit, int bo_recomm, String bo_status, String bo_note) {
		super();
		this.bo_no = bo_no;
	...
	public String toString() {
		return "Board [bo_no=" + bo_no + ", bo_category=" + bo_category + ", bo_division=" + bo_division + ", bo_pno="
				+ bo_pno + ", bo_date=" + bo_date + ", m_no=" + m_no + ", bo_title=" + bo_title + ", bo_content="
				+ bo_content + ", bo_hit=" + bo_hit + ", bo_recomm=" + bo_recomm + ", bo_status=" + bo_status
				+ ", bo_note=" + bo_note + "]";
	}
}
