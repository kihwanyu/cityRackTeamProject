			...
			<table style="width: 40%;">
				<tr>
					...
					<th width="25%" style="text-align: center; background: lightyellow">
						<input type="text" class="form-control" readonly="readonly" value="<%=p.getP_code()%>">
					</th>
			...
			<div class="productPosition">
				<table style="width: 80%; height: 70%">
					...
					<tr>			 
						...
						<td colspan="2">
							<input class="form-control" id="pname" type="text" value="<%=p.getP_name()%>">
						</td>
					</tr>
					<tr>			 
						<td style="text-align: center;">가격</td>
						<td colspan="2" style="text-align: left;">
							<input class="form-control" id="price" type="number" value="<%=p.getP_price()%>" name="price">
						</td>
					</tr>
					<%
					...
					<tr>
						...
						<td>
							<input id="new" type="checkbox" name="new" value="new" <%=eventChecked[0] %>> New
							<input id="hot" type="checkbox" name="hot" value="hot" <%=eventChecked[1] %>> Hot
							<input id="sale" type="checkbox" name="sale" value="sale" onclick="saleSelected();" <%=eventChecked[2] %>> Sale
							<div align="center" id="saleGroup" <%=hiddenChecked %>>
								<br>
								<label for="saleValues"> 할인율(%) : </label>
								<input id="saleValues" class="form-control" type="number" name="saleValues" min="1" max="100" value="<%=p.getP_discount() %>" style="width: 30%;">	
							</div>
						</td>
					</tr>
				</table>
